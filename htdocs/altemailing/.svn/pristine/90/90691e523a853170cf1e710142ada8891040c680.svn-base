...
/**
 *   	\file       htdocs/altemailing/tielist.php
 *		\ingroup    altemailing
 *		\brief      Thirdparties List page for Campagne
 */
...
$object = new CampagneThirdParties($db);
$extrafields = new ExtraFields($db);
$hookmanager->initHooks(array('campagnesoclist')); // Note that conf->hooks_modules contains array
...
$help_url = '';
$title = $langs->trans("CampagneThirdparties");
$morejs = array();
$morecss = array();
...
print dol_get_fiche_head($head, 'thirdparties', $langs->trans("Campagne"), -1, $campagne->picto);
